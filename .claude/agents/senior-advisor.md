...
- A review gate has rejected the same item three rounds in a row (`[REJECT]`), each time with new substantive findings. `[EDITORIAL]` rounds — wording, comments, test titles, commit-message claims — don't count.
