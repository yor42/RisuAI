export const languageVietnamese = {
    "formating": {
        ...
        "postEverything": "Lời nhắc chèn ở cuối"
    },
    "errors": {
        ...
        "networkFetch": "Điều này xảy ra khi mạng không ổn định hoặc máy chủ đang gặp sự cố.",
        "networkFetchWeb": "Đây có thể là lỗi CORS. Lỗi này chỉ xảy ra khi sử dụng phiên bản web do giới hạn của trình duyệt. Hãy thử dùng phiên bản desktop cục bộ, hoặc một phiên bản khác của Risuai.",
        ...
        "coldStorageChatDataMissing": (coldDataKey: string) =>
            `Không tìm thấy dữ liệu đã lưu của cuộc trò chuyện này (khóa: ${coldDataKey}). Nếu bạn có bản sao lưu từ thiết bị khác, hãy khôi phục nó trước. Nếu không, dữ liệu đã bị mất và bạn có thể xóa cuộc trò chuyện này.`,
    ...
    "help": {
        ...
        "localNetworkModeDesc": "Định tuyến các URL mô hình riêng tư/LAN qua đường dẫn runtime cục bộ thay vì fetch trực tiếp từ trình duyệt.\n\n**Mục đích**\n- Tránh các hạn chế mạng riêng tư/CORS của trình duyệt đối với `192.168.x.x`, `10.x.x.x`, `localhost`, `.local` và các host cục bộ tương tự.\n- Giảm rủi ro hết thời gian chờ (timeout) đối với suy luận cục bộ có token đầu tiên chậm ở chế độ tự lưu trữ Node.\n\n**Cách hoạt động**\n- Chỉ áp dụng khi Chế độ Mạng Cục bộ được bật và URL đích được phát hiện là cục bộ/riêng tư.\n- Tự lưu trữ Node: luồng streaming sử dụng relay Job+WebSocket thử nghiệm trước (dự phòng sang `/proxy2` nếu thất bại); không streaming sử dụng `/proxy2`.\n- Tauri: sử dụng đường dẫn gốc/trực tiếp.\n- Chế độ web công khai: bị chặn đối với các cuộc gọi trực tiếp cục bộ/riêng tư theo thiết kế.\n\n**Ràng buộc**\n- Phạm vi chỉ áp dụng cho các đường dẫn yêu cầu tương thích OpenAI.\n- Điều này không bỏ qua giới hạn nguồn gốc của Cloudflare giữa hai tên miền công khai.\n- Sử dụng URL tự lưu trữ của bạn (nơi `globalThis.__NODE__ === true`) để tính năng này có hiệu lực.",
        ...
        "antiClaudeOverload": "Nếu xảy ra quá tải Claude, Risuai sẽ cố gắng ngăn chặn bằng cách tiếp tục với cùng một lời nhắc, giúp giảm khả năng xảy ra lỗi. Chỉ hoạt động với các phản hồi được truyền trực tuyến. Điều này có thể không hoạt động đối với các điểm cuối api không chính thức.",
        ...
        "dynamicAssets": "Nếu được bật, nếu tên tài sản không được tìm thấy khi xử lý dữ liệu, nó sẽ cố gắng tìm tên tài sản gần nhất bằng cách sử dụng tìm kiếm vector và thay thế nó bằng tên tài sản gần nhất.",
        ...
        "namespace": "Namespace là một định danh duy nhất cho mô-đun. Nó được sử dụng để ngăn xung đột giữa các mô-đun, và cho sự tương tác của các cài đặt trước, các mô-đun khác, v.v. Nếu bạn không chắc chắn nên đặt gì, hãy để trống.",
        "moduleIntergration": "Bạn có thể kích hoạt các mô-đun bằng cách đặt namespace mô-đun vào phần tích hợp mô-đun. Nếu bạn muốn kích hoạt nhiều mô-đun, bạn có thể phân tách chúng bằng dấu phẩy. Ví dụ, `module1,module2,module3`. Điều này dành cho người dùng nâng cao, những người muốn thay đổi việc sử dụng các mô-đun theo cài đặt trước.",
        ...
        "translatorNote": "Tại đây, bạn có thể thêm lời nhắc dịch duy nhất cho mỗi nhân vật. Tùy chọn này chỉ áp dụng khi sử dụng mô hình Ax. để dịch. Để áp dụng, bao gồm `{{slot::tnote}}` trong cài đặt ngôn ngữ. Nó không hoạt động trong các cuộc trò chuyện nhóm.",
        ...
        "presetChain": "Nếu không trống, cài đặt trước sẽ được thay đổi và áp dụng ngẫu nhiên mỗi khi người dùng gửi tin nhắn trong danh sách cài đặt trước ở đầu vào này. Danh sách cài đặt trước nên được phân tách bằng dấu phẩy, ví dụ, `preset1,preset2`.",
        ...
        "keepSessionAlive": "Giữ cho tab hoạt động và ngăn phiên hết hạn do không hoạt động trong trình duyệt. Điều này có thể cần tải lại trang để có hiệu lực.\n\n- **Qua Âm thanh**: Phát một đoạn âm thanh im lặng theo định kỳ để giữ phiên hoạt động. Phương pháp này được biết là tương thích và hiệu quả nhất trên hầu hết các trình duyệt.\n",
        "reSummarizationPrompt": "Lời nhắc được sử dụng khi gộp nhiều tóm tắt đã chọn thành một thông qua chỉnh sửa hàng loạt. Nếu để trống, lời nhắc mặc định sẽ được sử dụng.",
        "hypaV3MemoryTokensRatio": "Tỷ lệ của kích thước ngữ cảnh tối đa được phân bổ cho khối bộ nhớ dài hạn {{slot}} trong lời nhắc.",
        "hypaV3ExtraSummarizationRatio": "Hạ thấp ngưỡng mà tại đó việc tóm tắt dừng lại. Ở mức 0, việc tóm tắt dừng ngay khi số token giảm xuống dưới ngữ cảnh tối đa. Giá trị cao hơn sẽ khiến việc tóm tắt diễn ra nhiều hơn trước khi dừng.",
        "hypaV3MaxChatsPerSummary": "Số lượng tin nhắn trò chuyện tối đa được đưa vào khi tạo một bản tóm tắt.",
        "hypaV3RecentMemoryRatio": "Tỷ lệ token bộ nhớ được phân bổ cho bộ nhớ gần đây. Tự động được lấp đầy bằng các bản tóm tắt được tạo gần đây nhất cho đến khi số token được phân bổ đầy.",
        "hypaV3SimilarMemoryRatio": "Tỷ lệ token bộ nhớ được phân bổ cho bộ nhớ tương tự. Tự động được lấp đầy bằng các bản tóm tắt có điểm tương đồng cao nhất với các cuộc trò chuyện gần đây cho đến khi số token được phân bổ đầy.",
        "hypaV3RandomMemoryRatio": "Được lấp đầy ngẫu nhiên từ các bản tóm tắt chưa được chọn bởi các danh mục khác.",
        "hypaV3PreserveOrphanedMemory": "Nếu được bật, các bản tóm tắt tham chiếu đến tin nhắn trò chuyện đã bị xóa sẽ được giữ lại. Nếu tắt, các bản tóm tắt có tin nhắn nguồn không còn tồn tại sẽ tự động bị xóa.",
        "hypaV3ProcessRegexScript": "Nếu được bật, các script regex sẽ được áp dụng cho tin nhắn trò chuyện đầu vào khi tạo lại các bản tóm tắt trong modal HypaV3.",
        "hypaV3DoNotSummarizeUserMessage": "Nếu được bật, tin nhắn của người dùng sẽ bị loại khỏi số lượng tin nhắn tối đa cho mỗi bản tóm tắt.",
        "hypaV3EnableSimilarityCorrection": "Nếu được bật, một bản tóm tắt của các cuộc trò chuyện gần đây sẽ được sử dụng bổ sung làm truy vấn. Không hoạt động với HypaMemory V3 thử nghiệm.",
        "hypaV3UseExperimentalImpl": "Chuyển sang triển khai HypaMemory V3 thử nghiệm. Bật cài đặt giới hạn tốc độ và thay đổi phương thức truy vấn.",
        "hypaV3AlwaysToggleOn": "Nếu được bật, nút chuyển đổi HypaMemory sẽ tự động được kích hoạt khi chọn nhân vật.",
        "hypaV3SummarizationRequestsPerMinute": "Số yêu cầu mô hình SupaMemory tối đa mỗi phút cho việc tóm tắt. Chỉ áp dụng khi mô hình SupaMemory được đặt thành Mô hình phụ trợ.",
        "hypaV3SummarizationMaxConcurrent": "Số yêu cầu mô hình SupaMemory đồng thời tối đa cho việc tóm tắt. Chỉ áp dụng khi mô hình SupaMemory được đặt thành Mô hình phụ trợ.",
        "hypaV3EmbeddingRequestsPerMinute": "Số yêu cầu mô hình nhúng tối đa mỗi phút cho tìm kiếm tương đồng.",
    ...
    "enableBlockPartialEdit": "Bật Chỉnh sửa Từng phần theo Khối (Di chuột để chỉnh sửa từng khối)",
    "enableDragPartialEdit": "Bật Chỉnh sửa Từng phần bằng Kéo chọn (Chọn văn bản để chỉnh sửa)",
    ...
    "hub": "RisuRealm",
    "hubLoadFailed": "Không thể tải RisuRealm. Vui lòng kiểm tra kết nối của bạn và thử lại.",
    "hubEmpty": "Hiện không tìm thấy nhân vật nào trong RisuRealm.",
    "hubOffline": "Bạn đang ngoại tuyến. Hãy kết nối internet để duyệt RisuRealm.",
    "hubRetry": "Thử lại",
    "hubBrowseMore": "Duyệt RisuRealm",
    "hubDescription": "Duyệt thêm nhân vật bằng RisuRealm.",
    "hubAnnouncementTitle": "Thông báo từ RisuRealm",
    "homeVersion": "Phiên bản",
    "homeLinkDiscordTitle": "Discord",
    "homeLinkDiscordDescription": "Tham gia máy chủ Discord của chúng tôi để trò chuyện với người dùng khác và nhà phát triển.",
    "homeLinkWebsiteTitle": "Trang web",
    "homeLinkWebsiteDescription": "Xem trang web chính thức của dự án.",
    "homeLinkGithubTitle": "Mã nguồn & Vấn đề",
    "homeLinkGithubDescription": "Xem mã nguồn hoặc gửi vấn đề trên GitHub.",
    "homeSourceRepoLabel": "Mã nguồn",
    "homeSourceIssuesLabel": "Vấn đề",
    "homeSourceUpstreamLabel": "upstream",
    "homeLinkEmailTitle": "Email",
    "homeLinkEmailDescription": "Liên hệ trực tiếp với nhà phát triển.",
    "homeSourceEmailForkLabel": "Liên hệ người bảo trì",
    ...
    "adaptiveThinkingEffort": "Mức độ Suy nghĩ Thích ứng",
    ...
    "hotkeyDesc": {
        ...
        "popupEditor": "Trình soạn thảo Popup",
        "loadout": "Loadout"
    },
    ...
    "partialBackupFirstConfirm": "⚠️ CẢNH BÁO: Sao lưu Cục bộ Từng phần ⚠️\n\nBản sao lưu này nhanh chóng chỉ lưu các thông tin thiết yếu.\n\nBao gồm:\n- Cơ sở dữ liệu (lịch sử trò chuyện, nhân vật, module, plugin, lời nhắc, cài đặt, v.v.)\n- Biểu tượng hồ sơ nhân vật (hình ảnh chính)\n- Biểu tượng người dùng và hình nền tùy chỉnh\n- Biểu tượng Persona\n- Hình ảnh thư mục\n- Hình ảnh cấu hình sẵn của bot\n\n⚠️ KHÔNG bao gồm:\n- Hình ảnh cảm xúc\n- Tài sản bổ sung của nhân vật\n- Tệp giọng nói VITS\n- Tất cả các tệp phương tiện bổ sung khác\n\nTệp sao lưu này KHÔNG bao gồm toàn bộ tài sản nhân vật!\nNếu bạn cần một bản sao lưu đầy đủ, hãy dùng bản sao lưu cục bộ thông thường.\n\nBạn có muốn tiếp tục không?",
    "partialBackupSecondConfirm": "⚠️⚠️ CẢNH BÁO CUỐI CÙNG ⚠️⚠️\n\nBản sao lưu này chỉ lưu hình ảnh hồ sơ nhân vật và KHÔNG lưu hầu hết các tài sản khác!\n\nNhững gì sẽ được lưu:\n- Cơ sở dữ liệu (lịch sử trò chuyện, nhân vật, module, plugin, lời nhắc, cài đặt, v.v.)\n- Biểu tượng hồ sơ nhân vật (hình ảnh chính)\n- Biểu tượng người dùng và hình nền tùy chỉnh\n- Biểu tượng Persona\n- Hình ảnh thư mục\n- Hình ảnh cấu hình sẵn của bot\n\nNhững gì sẽ KHÔNG được lưu:\n- Hình ảnh cảm xúc\n- Tài sản bổ sung của nhân vật\n- Tệp giọng nói VITS\n- Tất cả các tệp phương tiện khác\n\n⚠️ CHỈ tiếp tục NẾU bạn không cần tài sản nhân vật trong tệp sao lưu của mình! ⚠️\n\nBạn có thực sự chắc chắn muốn tiếp tục sao lưu từng phần không?",
    "savePartialLocalBackup": "Lưu Sao lưu Từng phần Cục bộ (Không bao gồm Tài sản Nhân vật)",
    "encryptedBackupRefused": "Bản sao lưu này được RisuAccount mã hóa và không thể đọc được ở đây vì lý do kỹ thuật. Không có gì được nhập.\n\nTrong RisuAI thượng nguồn, bạn vẫn có thể chuyển dữ liệu này sang:\n\n1. Dùng \"Save Partial Backup Locally (Excluding Character Assets)\". Bản này không được mã hóa và giữ lại mọi cuộc trò chuyện, kể cả bộ nhớ lạnh. Nó giữ lại ảnh hồ sơ của nhân vật, nhóm và Persona, biểu tượng người dùng, hình nền, cùng ảnh thư mục và cấu hình sẵn. Nó bỏ qua các hình ảnh khác và tệp VITS.\n\n2. \"Đăng xuất\" khỏi đồng bộ tài khoản, sau đó dùng \"Lưu sao lưu cục bộ\". Cách này giữ lại tài sản .png nhưng mất các cuộc trò chuyện trong bộ nhớ lạnh.\n\nLàm cả hai và nhập cả hai vào đây sẽ giữ lại mọi thứ. Xem hướng dẫn di chuyển để biết chi tiết.",
    "encryptedBackupImportStopped": "Bản sao lưu này chứa một phần được mã hóa và quá trình nhập đã dừng lại. Một số hình ảnh hoặc mục trong bộ nhớ lạnh có thể đã được thêm vào hoặc thay thế. Cơ sở dữ liệu hiện tại của bạn không bị thay đổi.",
    "backupFileUnreadable": "Không thể đọc tệp này. Không có gì được nhập.",
    ...
    "bootstrap": {
        ...
        "reportErrorQuestion": "Bạn có muốn báo cáo lỗi này cho nhà phát triển không?\nĐiều này giúp ngăn lỗi tương tự xảy ra lần nữa.\n(Chỉ bao gồm thông tin module bị hỏng, không có dữ liệu cá nhân)",
        "diagnosticInformation": (reportData: string) => `# Thông tin Chẩn đoán\n\nVui lòng sao chép thông tin bên dưới và báo cáo cho nhà phát triển qua GitHub Issues, Discord hoặc cộng đồng.\nHãy kiểm tra kỹ xem có thông tin nhạy cảm nào trước khi báo cáo.\n\n\`\`\`json\n${reportData}\n\`\`\``,
        "resetLorebookQuestion": "Bạn có muốn đặt lại CHỈ dữ liệu lorebook trong module bị hỏng cụ thể này không?\n(Các module khác và dữ liệu nhân vật sẽ KHÔNG bị ảnh hưởng)\n\nChọn \"Không\" sẽ giữ lại dữ liệu nhưng lỗi có thể vẫn tiếp diễn."
    },
    "partialEdit": {
        ...
        "matchFailedMessage": "Không thể xác định chính xác vị trí trong tin nhắn gốc. Điều này có thể xảy ra với các câu rất dài hoặc nội dung trùng lặp. Vui lòng sử dụng tính năng chỉnh sửa toàn bộ tin nhắn thay thế.",
        "selectMatch": "Chọn khối cần chỉnh sửa",
        "selectDeleteMatch": "Chọn khối cần xóa",
        "matchesFound": "kết quả khớp được tìm thấy",
    ...
    "confirmInstallPluginViaPlugin": "Bạn đang cố cài đặt một plugin thông qua một plugin khác. Điều này có thể nguy hiểm nếu plugin nguồn không đáng tin cậy. Bạn có muốn tiếp tục không?",
    ...
    "epRequirementsNotMet": "Chưa đáp ứng yêu cầu của Bảng Dễ dùng. Nhấp vào nút bên dưới để tự động điều chỉnh cài đặt của bạn cho cài đặt Bảng Dễ dùng tối ưu.",
    "seperateParametersByModel": "Tách Tham số theo Mô hình",
    "disableSeperateParameterChangeOnPresetChange": "Tắt Thay đổi Tham số Riêng khi Đổi Cấu hình sẵn",
    ...
    realmNewListingConfirm: "Thao tác này sẽ tạo một mục Realm mới. Để chỉnh sửa mục hiện có của bạn, hãy đăng nhập trên trang web chính thức của RisuRealm. Bạn có muốn tiếp tục không?",
    upstreamAgreementPromptBefore: "Tính năng này sử dụng một dịch vụ do RisuAI thượng nguồn vận hành, không phải do ứng dụng này. Để tiếp tục, hãy đồng ý với ",
    upstreamAgreementTermsOfService: "Điều khoản Dịch vụ",
    upstreamAgreementPromptBetween: " và ",
    upstreamAgreementPrivacyPolicy: "Chính sách Quyền riêng tư",
    upstreamAgreementPromptAfter: ".",
    upstreamAgreementAccept: "Đồng ý",
    upstreamAgreementDecline: "Không đồng ý",
    upstreamConsentPlaceholder: "Nội dung Realm đến từ một dịch vụ do RisuAI thượng nguồn vận hành. Hãy đồng ý với điều khoản của dịch vụ để hiển thị nó.",
    upstreamConsentShow: "Đồng ý và hiển thị",
