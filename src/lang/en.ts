export const languageEnglish = {
    ...
    hub: "RisuRealm",
    hubLoadFailed: "Failed to load RisuRealm. Please check your connection and try again.",
    hubEmpty: "No characters found in RisuRealm right now.",
    hubOffline: "You're offline. Connect to the internet to browse RisuRealm.",
    hubRetry: "Retry",
    hubBrowseMore: "Browse RisuRealm",
    hubDescription: "Browse more characters using RisuRealm.",
    hubAnnouncementTitle: "Announcement from RisuRealm",
    homeVersion: "Version",
    homeLinkDiscordTitle: "Discord",
    homeLinkDiscordDescription: "Join our Discord server to chat with other users and the developer.",
    homeLinkWebsiteTitle: "Website",
    homeLinkWebsiteDescription: "See the official website for the project.",
    homeLinkGithubTitle: "Source & Issues",
    homeLinkGithubDescription: "Browse the source code or file an issue on GitHub.",
    homeSourceRepoLabel: "Source code",
    homeSourceIssuesLabel: "Issues",
    homeSourceUpstreamLabel: "upstream",
    homeLinkEmailTitle: "Email",
    homeLinkEmailDescription: "Contact the developer directly.",
    homeSourceEmailForkLabel: "Contact the maintainer",
    ...
    otherTabSavedTitle: "Another tab just saved changes, and this tab still has unsaved changes of its own. What would you like to do?",
    otherTabSavedSaveMine: "Save my changes (this may overwrite what the other tab saved)",
    otherTabSavedDiscardMine: "Discard my changes and reload",
    otherTabSavedConflictTitle: "Another tab just saved changes, and this tab's copy of the server data is now out of date. Your changes here can't be saved from this tab; only reloading gets a working, saveable state again — any unsaved local changes will be lost.",
    otherTabSavedConflictReload: "Reload now",
    ...
    realmNewListingConfirm: "This will create a new Realm listing. To edit your existing listing instead, sign in on RisuRealm's own site. Continue?",
    upstreamAgreementPromptBefore: "This feature uses a service operated by upstream RisuAI, not by this app. To continue, accept its ",
    upstreamAgreementTermsOfService: "Terms of Service",
    upstreamAgreementPromptBetween: " and ",
    upstreamAgreementPrivacyPolicy: "Privacy Policy",
    upstreamAgreementPromptAfter: ".",
    upstreamAgreementAccept: "Accept",
    upstreamAgreementDecline: "Do not accept",
    upstreamConsentPlaceholder: "Realm content comes from a service operated by upstream RisuAI. Agree to its terms to show it.",
    upstreamConsentShow: "Agree and show",
