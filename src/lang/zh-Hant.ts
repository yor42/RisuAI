export const languageChineseTraditional = {
    ...
    "updateRealmDesc": "您正嘗試將角色更新至 RisuRealm。這將把您的角色更新至 RisuRealm，且無法復原。",
    ...
    "connectionOpenInfo": "多人房間已開啟。您可以將房間代碼分享給其他使用者。其他人可以在遊樂場 > 加入多人房間中輸入代碼以加入房間。",
    "createMultiuserRoom": "建立多人房間",
    "connectionHost": "您是這個房間的主機。",
    "connectionGuest": "您是這個房間的訪客。",
    "otherUserRequesting": "其他使用者正在請求中，請稍後再試。",
    ...
    "skipSavingAssetsOnWebSync": "網頁同步時跳過儲存資源",
