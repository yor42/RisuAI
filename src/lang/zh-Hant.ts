export const languageChineseTraditional = {
    ...
    "errors": {
        ...
        "coldStorageChatDataMissing": (coldDataKey: string) =>
            `找不到此對話的儲存資料（金鑰：${coldDataKey}）。若您在其他裝置上有備份，請先復原該備份。否則資料已遺失，您可以刪除此對話。`,
    ...
    "createGroupImg": "生成群組圖示",
    "waifuWidth": "角色對話框寬度",
    "savebackup": "儲存備份至 Google",
    ...
    "pasteAuthCode": "請將快顯視窗中的驗證碼複製並貼在此處：",
    "others": "其他",
    "presets": "預設",
    ...
    "orderByOrder": "依序發言",
    "removeFromGroup": "您確定要將 {{char}} 從群組中移除嗎？",
    "talkness": "健談程度",
    "active": "活躍",
    ...
    "hub": "RisuRealm",
    "hubLoadFailed": "載入 RisuRealm 失敗，請檢查您的網路連線後重試。",
    "hubEmpty": "目前在 RisuRealm 中找不到任何角色。",
    "hubOffline": "您目前處於離線狀態。連上網路即可瀏覽 RisuRealm。",
    "hubRetry": "重試",
    "hubBrowseMore": "瀏覽 RisuRealm",
    "hubDescription": "使用 RisuRealm 瀏覽更多角色。",
    "hubAnnouncementTitle": "來自 RisuRealm 的公告",
    "homeVersion": "版本",
    "homeLinkDiscordTitle": "Discord",
    "homeLinkDiscordDescription": "加入我們的 Discord 伺服器，與其他使用者和開發者交流。",
    "homeLinkWebsiteTitle": "網站",
    "homeLinkWebsiteDescription": "查看專案的官方網站。",
    "homeLinkGithubTitle": "原始碼 & 議題",
    "homeLinkGithubDescription": "瀏覽原始碼，或在 GitHub 上提交議題。",
    "homeSourceRepoLabel": "原始碼",
    "homeSourceIssuesLabel": "議題",
    "homeSourceUpstreamLabel": "上游",
    "homeLinkEmailTitle": "電子郵件",
    "homeLinkEmailDescription": "直接聯絡開發者。",
    "homeSourceEmailForkLabel": "聯絡維護者",
    ...
    "googleDriveConnection": "Google Drive 連接",
    ...
    "hypaChunkSize": "區塊大小",
    "hypaV2Desc": "HypaMemory V2 是一個長期記憶系統，同時使用摘要資料與向量搜尋。",
    "supaDesc": "SupaMemory 是一個使用摘要資料提供給 AI 的長期記憶系統。",
    ...
    "importTranslationCacheFailed": "已匯入 {0} 筆條目，但有 {1} 筆條目儲存失敗。儲存空間可能已滿。",
    "exportTranslationCacheEmpty": "翻譯快取為空。",
    "clearTranslationCache": "清除翻譯快取",
    "clearTranslationCacheSuccess": "翻譯快取清除成功。",
    ...
    "hypaV3Settings": {
        ...
        "summaryChunkSeparatorLabel": "區塊分隔符號正規表達式",
    ...
    "realmNewListingConfirm": "此操作將建立一個新的 RisuRealm 項目。若要編輯現有項目，請改在 RisuRealm 官方網站登入。是否要繼續？",
    "upstreamAgreementPromptBefore": "此功能使用的服務由上游 RisuAI 營運，而非本應用程式。若要繼續，請同意其",
    "upstreamAgreementTermsOfService": "服務條款",
    "upstreamAgreementPromptBetween": "和",
    "upstreamAgreementPrivacyPolicy": "隱私政策",
    "upstreamAgreementPromptAfter": "。",
    "upstreamAgreementAccept": "同意",
    "upstreamAgreementDecline": "不同意",
    "upstreamConsentPlaceholder": "Realm 內容來自上游 RisuAI 營運的服務。請同意其條款以顯示。",
    "upstreamConsentShow": "同意並顯示",
